      ...
      <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
          ...
          <p class="text-center text-gray-600 mb-8">
            ...
            therapists who work with MINDBRIDGE.
            <span class="inline-block w-5 h-5 bg-green-500 rounded-full text-white text-center"
              >i</span
            >
          </p>
          ...
          <div class="bg-green-800 rounded-t-3xl pt-16 pb-4 px-4">
            <h2 class="text-2xl font-semibold text-white text-center mb-8">
              MINDBRIDGE reviews from {{ currentDate }}
            </h2>
...
const reviews = ref([
  {
    id: 593144,
    quote:
      "Kathryn has taught me so much about myself and really opened my eyes. I'm so happy I signed up for MINDBRIDGE and got paired with her. It has felt so natural speaking with her and not forced. She is...",
    therapistName: 'Kathryn Bondura, LCSW',
    therapistImage: '/placeholder.svg?height=48&width=48',
    details:
      'Review written after working with Kathryn Bondura for 1 month on issues concerning depression, stress, anxiety, relationship issues, family conflicts, trauma and abuse, grief,...',
  ...
  },
  {
    ...
    therapistImage: '/placeholder.svg?height=48&width=48',
    details:
      'Review written after working with Christine McInnes for 1 year and 4 months on issues concerning depression, stress, anxiety, addictions, relationship issues, family conflict...',
    date: 'September 26, 2024',
    rating: 4
  },
  {
    id: 593142,
    quote:
      'Vicky has been brilliant. Every step of my journey she has listened and understood and I am now at a point of being myself again. Thank you for everything.',
    therapistName: 'Bupinderjeet (aka Vicky) Kooner, BACP',
    therapistImage: '/placeholder.svg?height=48&width=48',
    details:
      'Review written after working with Bupinderjeet (aka Vicky) Kooner for 7 months on issues concerning relationship issues, self esteem, coping with life changes, and coaching',
    date: 'September 26, 2024',
    rating: 5
  },
  {
    id: 593141,
    quote:
      'Susan is respectful, offers insight, asks good questions for my consideration, and is supportive of my journey.',
